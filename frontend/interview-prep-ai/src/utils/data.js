export const CARD_BG = [
  ...
  { id: 2, bgcolor: "linear-gradient(135deg, #fef9e7 0%, #fffbf4 100%)" },
  { id: 3, bgcolor: "linear-gradient(135deg, #eaf7ff 0%, #f3fbff 100%)" },
  { id: 4, bgcolor: "linear-gradient(135deg, #fffe29 0%, #fff8f3 100%)" },
  { id: 5, bgcolor: "linear-gradient(135deg, #e7f6fe 0%, #f4faf4 100%)" },
...
export const APP_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Easily save your interview sets, organie them neatly in your dashboard, and pick up your preparation.",
  },
];
